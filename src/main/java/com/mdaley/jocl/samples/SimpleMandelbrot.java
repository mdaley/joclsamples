...
public class SimpleMandelbrot
{
    ...
    /**
     * Creates the SimpleMandelbrot sample with the given
     * width and height
     */
    public SimpleMandelbrot(int width, int height)
    {
        this.sizeX = width;
        this.sizeY = height;
    ...
    private String readFile(String fileName)
    {
        try
        {
            BufferedReader br = new BufferedReader(
                    new InputStreamReader(SimpleMandelbrot.class.getResourceAsStream(fileName)));
