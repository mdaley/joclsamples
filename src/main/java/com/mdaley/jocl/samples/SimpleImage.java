...
public class SimpleImage
{
    ...
    private static BufferedImage createBufferedImage(String fileName)
    {
        ...
        try
        {
            image = ImageIO.read(SimpleImage.class.getResourceAsStream("/lena512color.png"));
        }
        catch (IOException e)
        {
            e.printStackTrace();
    ...
    void initCL()
    {
        ...
        // CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE doesn't work on OSX! I think it is just an optimisation.
